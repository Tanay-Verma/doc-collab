...
const Dropdown: React.FC<DropdownProps> = ({
  ...
  // navigae the user to a different page
    ...
    if (listType === "folder") {
      ...
      if (error) {
        toast({
          title: "Error",
          variant: "destructive",
          description: "Could not not move the folder to trash",
        });
      } else {
        toast({
          title: "Success",
    ...
    if (listType === "file") {
      ...
      if (error) {
        toast({
          title: "Error",
          variant: "destructive",
          description: "Could not not move the file to trash",
        });
      } else {
        toast({
          title: "Success",
          ...
          >
            ...
            <input
              ...
              className={clsx(
                ...
                {
                  "bg-muted cursor-pointer": isEditing,
          ...
          <div className={hoverStyles}>
            <TooltipComponent message="Delete Folder">
              <Trash
                onClick={moveToTrash}
                size={15}
                className="hover:dark:text-white dark:text-Neutrals/neutrals-7 transition-colors mr-3"
              />
            </TooltipComponent>
